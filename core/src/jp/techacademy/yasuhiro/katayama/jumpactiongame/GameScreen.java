...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.yasuhiro.katayama.jumpactiongame");
    ...
    public void render(float delta) {
        ...
        mGame.batch.begin();
        mFont.draw(mGame.batch, "HighScore:" + mHightScore, 16, GUI_HEIGHT - 15);
